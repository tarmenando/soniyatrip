...
const BaliPricingModal: React.FC<PricingModalProps> = ({ onClose }) => {
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="text-3xl sm:text-4xl font-extrabold text-center mb-6 sm:mb-8 text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-yellow-500">Tabel Harga Trip Bali</h2>
...
export default BaliPricingModal;
